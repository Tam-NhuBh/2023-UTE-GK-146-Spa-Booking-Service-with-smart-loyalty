...
class CartController {
    ...
    listProduct (req,res) {
        const userId = req.query.userId; // Giả sử thông tin ID người dùng đã được lưu vào req.user từ quá trình đăng nhập    
      ...
      addToCart(req, res) 
      {
            ...
            const checkExistingProductQuery = `
                SELECT idProduct FROM listproductpayment 
                ...
                if (checkErr) {
                    ...
                    if (checkResult.length > 0) {
                        ...
                        const insertNewProductQuery = `
                            INSERT INTO listproductpayment (idUser, idProduct, quantity)
                            VALUES (${userId}, ${idProduct}, ${quantity});
                        `;
